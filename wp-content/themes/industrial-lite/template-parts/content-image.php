...
<article id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
  <div class="post-main-box ">
    <?php $industrial_lite_theme_lay = get_theme_mod( 'industrial_lite_blog_layout_option','Default');
    ...
    <?php }else if($industrial_lite_theme_lay == 'Center'){ ?>
    ...
    <?php }else if($industrial_lite_theme_lay == 'Left'){ ?>
      <div class="service-text">
        <div class="box-image">
          <?php the_post_thumbnail(); ?>
        </div>
