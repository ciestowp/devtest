...
<div class="wrapper-info">
    ...
    <div class="tab-sec">
		<div class="tab">
			...
			<button class="tablinks" onclick="industrial_lite_open_tab(event, 'block_pattern')"><?php esc_html_e( 'Setup With Block Pattern', 'industrial-lite' ); ?></button>
			<button class="tablinks" onclick="industrial_lite_open_tab(event, 'gutenberg_editor')"><?php esc_html_e( 'Setup With Gutunberg Block', 'industrial-lite' ); ?></button>
					...
					<div class="info-link">
			  		...
			  		<div class="link-customizer">
						...
						<div class="first-row">
							...
							<div class="row-box">
								<div class="row-box1">
									<span class="dashicons dashicons-admin-customizer"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=industrial_lite_global_typography') ); ?>" target="_blank"><?php esc_html_e('Typography','industrial-lite'); ?></a>
								</div>
								<div class="row-box2">
		...
		<div id="block_pattern" class="tabcontent">
				        ...
				        <?php if ($industrial_lite_actions): foreach ($industrial_lite_actions as $key => $industrial_lite_actionValue): ?>
				                <div class="industrial-lite-action" id="<?php echo esc_attr($industrial_lite_actionValue['id']);?>">
			                        <div class="action-inner">
			                            ...
			                            <div class="action-desc"><?php echo esc_html($industrial_lite_actionValue['desc']); ?></div>
			                            <?php echo wp_kses_post($industrial_lite_actionValue['link']); ?>
			                            <a class="ibtana-skip-btn" href="javascript:void(0);" get-start-tab-id="gutenberg-editor-tab"><?php esc_html_e('Skip','industrial-lite'); ?></a>
			                        </div>
				                </div>
				            <?php endforeach;
				        endif; ?>
			...
			<?php } ?>
			<div class="gutenberg-editor-tab" style="<?php echo esc_attr($industrial_lite_plugin_custom_css); ?>">
				<div class="block-pattern-img">
				  	<h3><?php esc_html_e( 'Block Patterns', 'industrial-lite' ); ?></h3>
					<hr class="h3hr">
					<p><?php esc_html_e('Follow the below instructions to setup Home page with Block Patterns.','industrial-lite'); ?></p>
	              	<p><b><?php esc_html_e('Click on Below Add new page button >> Click on "+" Icon >> Click Pattern Tab >> Click on homepage sections >> Publish.','industrial-lite'); ?></span></b></p>
	              	<div class="industrial-lite-pattern-page">
				    	<a href="javascript:void(0)" class="vw-pattern-page-btn button-primary button"><?php esc_html_e('Add New Page','industrial-lite'); ?></a>
				    </div>
              	...
              	<div class="block-pattern-link-customizer">
						...
						<div class="first-row">
							<div class="row-box">
								...
								<div class="row-box2">
									<span class="dashicons dashicons-networking"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=industrial_lite_social_icon_settings') ); ?>" target="_blank"><?php esc_html_e('Social Icons','industrial-lite'); ?></a>
								</div>
							</div>
							<div class="row-box">
								<div class="row-box1">
		...
		<div id="gutenberg_editor" class="tabcontent">
			...
			<?php }else{ ?>
				<h3><?php esc_html_e( 'Gutunberg Blocks', 'industrial-lite' ); ?></h3>
				<hr class="h3hr">
				<div class="industrial-lite-pattern-page">
			    	<a href="<?php echo esc_url( admin_url( 'admin.php?page=ibtana-visual-editor-templates' ) ); ?>" class="vw-pattern-page-btn ibtana-dashboard-page-btn button-primary button"><?php esc_html_e('Ibtana Settings','industrial-lite'); ?></a>
			    </div>
