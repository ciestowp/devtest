	...
	<script type="text/javascript">
		...
		var ajax_nonce = '<?php echo wp_create_nonce("secure_nonce_name"); ?>';
			...
			function hoveVariation()
			{
				...
				echo "<div class='variationColor' style='margin-bottom:10px;'>";
				foreach ($variations as $variation) {
					echo '<img src=' . $variation['image']['url'] . " width='50px' hight='50px' style='margin-left:10px;'>";
				}
				echo "</div>";
			...
			add_action('woocommerce_after_shop_loop_item_title', 'hoveVariation', 10);


			add_action('wp_enqueue_scripts', 'tutsplus_enqueue_custom_js');
			function tutsplus_enqueue_custom_js() {
				wp_enqueue_script('custom', get_stylesheet_directory_uri().'/main.js', 
